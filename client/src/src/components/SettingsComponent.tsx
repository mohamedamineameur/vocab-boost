...
export default function SettingsComponent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#3B82F6] via-[#60A5FA] to-[#22C55E] p-4" dir={isRTL ? "rtl" : "ltr"}>
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="bg-white rounded-2xl shadow-2xl p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            <User className="w-8 h-8 text-[#3B82F6]" />
            <h1 className="text-2xl font-bold text-[#111827]">{t("settings")}</h1>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6">
          {activeTab === "profile" && (
            <div>
              <h2 className="text-xl font-semibold text-[#111827] mb-6">{t("personalInfo")}</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-[#F3F4F6] bg-white text-[#111827] focus:ring-2 focus:ring-[#3B82F6] focus:border-transparent outline-none transition-all"
                      required
                    />
                  </div>
          ...
          {activeTab === "password" && (
            <div>
              <h2 className="text-xl font-semibold text-[#111827] mb-6">{t("password")}</h2>
              
              <form onSubmit={handlePasswordUpdate} className="space-y-6">
                {/* Mot de passe actuel */}
                <div>
                  <label htmlFor="currentPassword" className="block text-sm font-medium text-[#111827] mb-2">
                    {t("currentPassword")}
                  </label>
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 pr-12 rounded-xl border border-[#F3F4F6] bg-white text-[#111827] focus:ring-2 focus:ring-[#3B82F6] focus:border-transparent outline-none transition-all"
                      required
                    />
                    <button
                      type="button"
                ...
                <div>
                  <label htmlFor="newPassword" className="block text-sm font-medium text-[#111827] mb-2">
                    {t("newPassword")}
                  </label>
                  <div className="relative">
                    <input
          ...
          {activeTab === "sessions" && (
            <div>
              <h2 className="text-xl font-semibold text-[#111827] mb-6">{t("sessions")}</h2>
              
              <div className="text-center py-8">
                <Shield className="w-16 h-16 mx-auto text-[#3B82F6] mb-4" />
                <p className="text-[#111827]/70 mb-6">{t("manageSessions")}</p>
                <button
