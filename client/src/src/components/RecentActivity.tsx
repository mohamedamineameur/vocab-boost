  ...
  if (activities.length === 0) {
    return (
      <div className="space-y-4" dir={isRTL ? "rtl" : "ltr"}>
        ...
        <div className="p-6 rounded-2xl bg-white border border-[#F3F4F6] text-center">
    ...
    <div className="space-y-4" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <div className="space-y-2">
        {activities.slice(0, 5).map((activity) => (
          <div
            key={activity.id}
            className="p-3 rounded-2xl bg-white border border-[#F3F4F6] shadow-sm hover:shadow-md transition flex items-center gap-3"
          >
            {/* Icône */}
            <div
