...
export default function DashboardPage() {
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-[#F3F4F6]">
        <div className="max-w-xl mx-auto px-5 py-8">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="h-24 rounded-2xl border border-black/10 bg-white shadow-sm overflow-hidden">
  ...
  // styles utilitaires
  const cardBase =
    "group relative w-full rounded-2xl border border-black/10 bg-white shadow-sm active:scale-[0.98] transition";
