      ...
      <div className="flex items-start gap-3">
        <div
          className={[
            ...
            selected ? "bg-white/20" : "bg-[#F3F4F6]"
          ].join(" ")}
        >
        ...
        <div className="max-w-3xl mx-auto px-5 py-5">
          ...
          {!loading && hasAnyUserCategories && !editing && (
            <section className="space-y-4">
              <div className="rounded-2xl bg-white p-4 shadow-md border border-black/5">
...
// ...
          ...
          {showPicker && (
            <section className="mt-2">
              <div className="mb-4 rounded-2xl border border-black/5 bg-white p-4 shadow-md"> 
      ...
      <nav className="sticky bottom-0 bg-white border-t border-black/5 sm:hidden">
