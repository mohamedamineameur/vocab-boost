...
export default function EnhancedDashboard() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Debug: Vérifier les quiz récupérés
        const quizArray = asArray(quizzesRes);
        console.log("🔍 Quiz array from API:", quizArray);
        console.log("🔍 First quiz details:", quizArray[0]);
      } catch (error) {
  ...
  console.log("🔍 About to calculate stats with:", {
