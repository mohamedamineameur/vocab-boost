        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="relative group">
            <input
              ...
              required
              maxLength={6}
              className="peer w-full px-4 pt-6 pb-2 border-2 rounded-2xl text-[#111827] bg-white/60 focus:bg-white transition-all focus:ring-2 focus:ring-[#3B82F6] outline-none text-center text-3xl font-bold tracking-widest"
