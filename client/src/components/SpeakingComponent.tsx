        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-3">
            <button
              type="button"
              onClick={handleReset}
              className="flex-1 py-3 px-6 rounded-2xl shadow-md bg-white dark:bg-gray-800 border border-[#F3F4F6] text-[#111827] hover:scale-105 active:scale-95 transition"
            >
              {t("tryAgain")}
            </button>
            <button
