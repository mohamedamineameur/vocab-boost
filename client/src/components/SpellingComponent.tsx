    ...
    <div className="space-y-4" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <input
          ...
          className="w-full px-4 py-3 rounded-2xl border border-[#F3F4F6] bg-white dark:bg-gray-800 text-[#111827] text-center text-lg focus:ring-2 focus:ring-[#3B82F6] outline-none disabled:opacity-50 disabled:cursor-not-allowed"
          autoFocus
        />
