      ...
      <div className="max-w-6xl mx-auto px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="px-3 py-1.5 rounded-xl bg-white dark:bg-gray-800/90 text-[#111827] text-sm font-medium border border-gray-200 dark:border-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#3B82F6] hover:cursor-pointer transition"
          >
