...
export default function QuizFlowRunner() {
  ...
  const fetchAnswer = useCallback(async (quizId: string, isCorrect: boolean) => {
    try {
      ...
      if (quiz && userWord) {
        trackQuiz(quizId, userWord.id, isCorrect, quiz.correctAnswer).catch(() => {
        });
      }
    } catch {
...
const renderQuiz = (q: Quiz) => {
  ...
  if (error) {
    return (
      <div className="max-w-xl mx-auto bg-white dark:bg-gray-800 border border-red-200 text-red-700 rounded-2xl p-4" dir={isRTL ? "rtl" : "ltr"}>
        {error}
      </div>
    );
  }
  ...
  if (quizzes.length === 0) {
    return (
      <div className="max-w-xl mx-auto bg-white dark:bg-gray-800 border border-[#F3F4F6] rounded-2xl p-6 text-center" dir={isRTL ? "rtl" : "ltr"}>
    ...
    return (
      <div className="w-full max-w-3xl mx-auto" dir={isRTL ? "rtl" : "ltr"}>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="p-4 rounded-2xl bg-white dark:bg-gray-800 border border-[#F3F4F6] shadow-md flex items-center gap-3">
  ...
  return (
    <div className="w-full max-w-3xl mx-auto" dir={isRTL ? "rtl" : "ltr"}>
          ...
          return (
            <button
              ...
              className={[
                ...
                isActive ? "bg-[#3B82F6] text-white border-[#3B82F6]" : "bg-white dark:bg-gray-800 text-[#111827] border-[#F3F4F6]",
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-[#F3F4F6] p-4 md:p-6 mb-24">
        {current ? renderQuiz(current) : null}
      </div>

      <div className="fixed left-0 right-0 bottom-0 bg-white dark:bg-gray-800/95 backdrop-blur border-t border-[#F3F4F6] p-3">
        <div className="max-w-3xl mx-auto grid grid-cols-2 gap-3">
          <button
            ...
            className={[
              ...
              canGoPrev ? "bg-white dark:bg-gray-800 border-[#F3F4F6] hover:scale-105 active:scale-95" : "bg-white dark:bg-gray-800 border-[#F3F4F6] opacity-50 cursor-not-allowed",
            ].join(" ")}
          >
