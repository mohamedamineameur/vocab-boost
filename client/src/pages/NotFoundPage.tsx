  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#3B82F6] via-[#60A5FA] to-[#22C55E] flex items-center justify-center px-4" dir={isRTL ? "rtl" : "ltr"}>
      <div className="max-w-2xl w-full text-center">
        {/* Container principal */}
        <div className="bg-white dark:bg-gray-800/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-12 border border-white/40">
          {/* Icône d'erreur */}
          <div className="mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-white dark:bg-gray-800 text-[#3B82F6] border-2 border-[#3B82F6] rounded-xl font-semibold hover:bg-[#3B82F6] hover:text-white transition-all duration-200"
              >
