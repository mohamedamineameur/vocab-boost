    ...
    <div className="min-h-screen bg-[#F3F4F6] p-4 md:p-8" dir={isRTL ? "rtl" : "ltr"}>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-[#F3F4F6] p-4">
              ...
              {(["en", "fr", "es", "ar"] as const).map((code) => (
                <button
                  ...
                  className={[
                    ...
                    setLang === code ? "bg-[#3B82F6] text-white border-[#3B82F6]" : "bg-white dark:bg-gray-800 text-[#111827] border-[#F3F4F6]",
                  ].join(" ")}
                >
                  {code.toUpperCase()}
                </button>
              ...
              {(["en", "fr", "es", "ar"] as const).map((code) => (
                <button
                  ...
                  className={[
                    "py-2 px-3 rounded-2xl border shadow-sm text-sm",
                    "transition hover:scale-105 active:scale-95",
                    language === code ? "bg-[#22C55E] text-white border-[#22C55E]" : "bg-white dark:bg-gray-800 text-[#111827] border-[#F3F4F6]",
                  ].join(" ")}
          ...
          {/* Score */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-[#F3F4F6] p-4 flex flex-col justify-between">
            <div>
        ...
        {/* Carte principale */}
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-[#F3F4F6] p-4 md:p-6">
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-2">
            ...
            <button
              type="button"
              onClick={reshuffle}
              className="w-full py-3 px-4 rounded-2xl bg-white dark:bg-gray-800 text-[#111827] border border-[#F3F4F6] shadow-md hover:scale-105 active:scale-95 transition inline-flex items-center justify-center gap-2"
            >
