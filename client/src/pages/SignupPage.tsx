...
function InputField({ icon, name, value, onChange, label, valid, type = "text" }: InputFieldProps) {
  const getClasses = (valid: boolean) =>
    `peer w-full pl-10 pr-12 pt-5 pb-2 border rounded-2xl text-[#111827] bg-white dark:bg-gray-800/60 focus:bg-white dark:bg-gray-800 transition-all outline-none ${
      valid ? "border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-[#3B82F6]" : "border-red-500 focus:ring-2 focus:ring-red-500"
    }`;
  return (
  ...
  return (
    <div className="relative group">
      ...
      <input
        ...
        onChange={onChange}
        required
        className={`peer w-full pl-10 pr-12 pt-5 pb-2 border rounded-2xl text-[#111827] bg-white dark:bg-gray-800/60 focus:bg-white dark:bg-gray-800 transition-all outline-none ${
          valid ? "border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-[#3B82F6]" : "border-red-500 focus:ring-2 focus:ring-red-500"
        }`}
      />
      <label className="absolute left-10 top-2 text-gray-400 text-sm transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:top-1 peer-focus:text-sm peer-focus:text-[#3B82F6]">
