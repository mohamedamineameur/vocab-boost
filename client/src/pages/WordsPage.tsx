        ...
        <div className="max-w-xl mx-auto px-5 py-8">
          ...
          <div className="grid grid-cols-1 gap-3">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="h-20 rounded-2xl border border-black/10 bg-white dark:bg-gray-800 shadow-sm overflow-hidden">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-[#F3F4F6]">
      <div className="max-w-xl mx-auto px-5 py-8">
        ...
        {/* Empty state */}
        {count === 0 && (
          <div className="mt-6 rounded-2xl border border-dashed border-black/10 bg-white dark:bg-gray-800 p-6 text-center shadow-sm">
          ...
          <div className="mt-3 grid grid-cols-1 gap-3">
            {filtered.map((w) => {
              ...
              return (
                <div
                  key={w.id}
                  className="group w-full rounded-2xl border border-black/10 bg-white dark:bg-gray-800 p-4 shadow-sm hover:shadow-md hover:border-[#22C55E]/30 transition"
                >
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="ml-1 inline-flex items-center justify-center rounded-full border border-black/10 bg-white dark:bg-gray-800 px-2 py-1 text-xs text-[#111827] hover:bg-black/5 active:scale-95"
                        ...
                        {translation && (
                          <p className="mt-1 text-sm text-[#111827] flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="inline-flex items-center justify-center rounded-full border border-black/10 bg-white dark:bg-gray-800 px-2 py-1 text-xs text-[#111827] hover:bg-black/5 active:scale-95"
