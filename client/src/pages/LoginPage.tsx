        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="relative group">
            ...
            <input
              ...
              required
              className="peer w-full pl-10 pr-4 pt-5 pb-2 border rounded-2xl text-[#111827] bg-white dark:bg-gray-800/60 focus:bg-white dark:bg-gray-800 transition-all focus:ring-2 focus:ring-[#3B82F6] outline-none"
            />
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-2 px-6 rounded-2xl font-medium text-[#3B82F6] shadow-md bg-white dark:bg-gray-800 border border-[#3B82F6] hover:bg-[#3B82F6] hover:text-white active:scale-95 transition transform disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {resendLoading ? (
                <>
